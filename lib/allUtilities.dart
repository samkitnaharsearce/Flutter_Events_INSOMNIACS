...
SendEmail(receiverEmail) async{
  ...
  String password = 'qrqbdrjmhnnonhul';
  ...
  try {
    ...
    final receiversReport = await connection.send(receiversMessage);

    // send the equivalent message
    final sendersReport = await connection.send(sendersMessage);

    // close the connection
    await connection.close();


    print('Message sent: ' + receiversReport.toString());
    print('Message sent: ' + sendersReport.toString());
    return true;
